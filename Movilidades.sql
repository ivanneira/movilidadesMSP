...
-- Tiempo de generación: 03-02-2017 a las 11:04:41
...
(1, 'Home', '2017-01-11 00:00:00', 0, '#', 'fa fa-home', 0),
(2, 'Localizacion', '2017-01-11 00:00:00', 0, '#', 'fa fa-map-marker', 5),
(3, 'Posicion actual', '2017-01-11 00:00:00', 2, '#', 'fa fa-crosshairs', 1),
(4, 'Historial por vehiculo', '2017-01-11 00:00:00', 2, '#', 'fa fa-history', 2),
(5, 'Usuarios', '2017-01-11 00:00:00', 0, '#', 'fa fa-user', 1),
(6, 'Administrar', '2017-01-11 00:00:00', 5, 'javascript:loadPage(\'abm_usuarios\');', 'fa fa-database', 0),
(7, 'Permisos', '2017-01-11 00:00:00', 0, '#', 'fa fa-key', 2),
(8, 'Vehiculos', '2017-01-11 00:00:00', 0, '#', 'fa fa-automobile', 3),
(9, 'Mantenimientos', '2017-01-11 00:00:00', 8, '#', 'fa fa-wrench', 0),
(10, 'Seguro', '2017-01-11 00:00:00', 8, '#', 'fa fa-lock', 0),
(11, 'Administrar', '2017-01-11 00:00:00', 7, 'javascript:loadPage(\'abm_permisos\');', 'fa fa-database', 0),
(12, 'Conductores', '2017-01-11 00:00:00', 0, '#', 'fa fa-group', 4),
(13, 'Administrar', '2017-01-11 00:00:00', 12, '#', 'fa fa-database', 0),
(14, 'Reparaciones', '2017-01-11 00:00:00', 8, '#', 'fa fa-legal', 0),
(15, 'Tarjeta Verde', '2017-01-11 00:00:00', 8, '#', 'fa fa-sticky-note', 0),
(16, 'Incidentes', '2017-01-11 00:00:00', 8, '#', 'fa fa-exclamation', 0),
(17, 'Configuracion', '2017-01-11 00:00:00', 0, '#', 'fa fa-gears', 7),
(19, 'Provincias', '2017-01-11 00:00:00', 17, '#', 'fa fa-dot-circle-o', 0),
(20, 'Departamentos', '2017-01-11 00:00:00', 17, '#', 'fa fa-dot-circle-o', 0),
(21, 'Localidades', '2017-01-11 00:00:00', 17, '#', 'fa fa-dot-circle-o', 0),
(99, 'es', NULL, 1, '1', NULL, 1),
(100, 'es', NULL, 1, '1', NULL, 1),
(111, 'asd', NULL, 1, '2', NULL, 2),
(123, 'a', NULL, 1, '1', NULL, 1),
(213, 'sadasd', NULL, 1, 'asdasd', NULL, 56),
(223, 'mend', NULL, 1, '###', NULL, 123),
(234, 'asd', NULL, 1, 'asd', NULL, 2),
(435, 'sdfsad', NULL, 1, 'fsdaf', NULL, 6),
(456, 'nkjhnkjd', NULL, 1, '###', NULL, 5),
(457, 'kjdhskj', NULL, 1, '###', NULL, 1),
(544, 'neira', NULL, 1, '####', NULL, 546),
(1000, 'mendoza', NULL, 1, '#', NULL, 2),
(2323, 'fgh', NULL, 1, 'fh', NULL, 5),
(34234, 'asdsad', NULL, 1, 'sadasd', NULL, 5),
(445345, 'xzczxc', NULL, 1, 'rerwer', NULL, 55),
(565456, 'asdasd', NULL, 1, 'sadasdasd', NULL, 8),
(2134234, 'qwe', NULL, 1, 'wqer', NULL, 45),
(3423234, 'asdas', NULL, 1, 'asddasd', NULL, 56),
(3423423, 'asdasd', NULL, 1, 'adsdsd', NULL, 4),
(34234234, 'asdasdas', NULL, 1, 'dasasdas', NULL, 7);
